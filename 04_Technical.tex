...
10000        & 2                          \\
20000        & 1                          \\
50000        & 1 (only on Lungs/NotLungs)
\end{tabular}
\caption{\textit{Tests Per Dataset}
\label{table:testsperdata}
\end{table}
